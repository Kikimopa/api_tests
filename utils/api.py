...
class GoogleMapsAPI:
    ...
    def get_new_location(place_id):
        ...
        get_resurce='/maps/api/place/get/json'  # Ресурс метода GET
    ...
    def put_new_location(place_id):
        ...
        put_resurce='/maps/api/place/update/json'  # Ресурс метода PUT
    ...
    def delete_new_location(place_id):
        ...
        delete_resurce='/maps/api/place/delete/json'  # Ресурс метода DELETE
        delete_url = base_url + delete_resurce + key
